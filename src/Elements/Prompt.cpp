...
Prompt::Prompt(LVScreen* parent, const char* text) : LVModal(parent){
	...
	lv_style_set_bg_color(&btnFocused, lv_color_make(50, 50, 50));
	...
	lv_obj_set_style_bg_color(avatarContainer, lv_color_black(), 0);
	...
	lv_obj_set_style_bg_color(labelContainer, lv_color_black(), 0);
	...
	lv_obj_set_style_text_font(yesLabel, &lv_font_montserrat_10, 0);
	...
	lv_obj_set_style_text_font(noLabel, &lv_font_montserrat_10, 0);
...
Prompt::~Prompt(){
	ESP_LOGD(tag, "prompt destructed");
