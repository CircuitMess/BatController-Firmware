...
DriveDirectionElement::DriveDirectionElement(lv_obj_t* parent) : LVObject(parent){
	...
	lv_canvas_set_buffer(canvasMain, bufferMain, 15, 15, LV_IMG_CF_TRUE_COLOR_CHROMA_KEYED);
	...
	lv_canvas_set_buffer(canvasHelper, bufferHelper, 15, 13, LV_IMG_CF_TRUE_COLOR_CHROMA_KEYED);
